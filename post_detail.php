  ...
  <div class="row">
   ...
   <div class="col-lg-8">
    ...
    <?php 
       ...
       ?>
    <div class="card mb-4">
                         <a href="#!"><img class="card-img-top" src="actions/post_photo/<?=$row['file_name'] ?>" alt="..." width="850px" /></a>
                        <div class="card-body">
                            <div class="small text-muted"<?= $row['created_at']?>>January 1, 2022</div>
                            <h2 class="card-title"><?= $row['title']?></h2>
                            <p class="card-text"><?= $row['description']?></p>
                            <a class="btn btn-primary" href="post_index.php"><- Back</a>
                        </div>
                    </div>
   </div>
        ...
        <form action="actions/post_comment_create.php" method="POST">
                                    <div class="form-outline mb-4">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <button type="submit" name="post_comment" class="btn btn-warning">Submit</button>
                                            </div>
                                        </div>
      ...
      if ($result->num_rows > 0) :
        ...
        ?>
            ...
            echo $profile['photo'];
               ...
               <p class="small mb-0 ms-2 my-5 mx-3"><?= time_Ago($row['created_at'])?></p>
              </div>
