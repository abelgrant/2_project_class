      ...
      <div class="card-body">
       ...
       <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="post_edit_form.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-danger mb-1"><i class="fa-solid fa-pen-to-square"></i></a>
           <a href="../actions/post_delete.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-primary mb-1"><i class="fa-solid fa-trash"></i></a>
           <a href="post_detail.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-danger mb-1"><i class="fa-solid fa-eye"></i></a>
          </td>
        </tr>
        <?php endwhile;?>
       </tbody>
